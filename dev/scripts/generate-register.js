...
console.log('🚀 Generating register.js from Lucide icons...\n');
...
try {
	...
	if (fs.existsSync(lucideIconsDir)) {
		...
		console.warn('⚠️  Lucide icons directory not found. Run ./download-dev-icons.sh first.');
	}
	...
	if (allIcons.length === 0) {
		console.error('❌ No icons found. Please run ./download-dev-icons.sh first.');
		process.exit(1);
	}
	...
	console.log(`\n🎉 Done! Your Icon Block plugin is ready to use.`);
